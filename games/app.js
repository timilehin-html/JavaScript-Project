...
// change( heading.innerHTML = "Play", 1000 )
// .then( () => {
//     return change(
//         heading.style.transform = "scale(0)" ,400 );
// } )
// .then( () => {
//     return change(
//     heading.innerHTML = "The Game",
//     heading.style.color = "rgb(242 146 146 / 97%)",
//     heading.style.textShadow = "0 5px 0 rgb(255 186 186)",
//     0000 );
// } )
// .then( () => {
...
// .then( () => {
//     return change(
//         heading.style.color = "rgb(229 242 146 / 97%)",
//         heading.style.textShadow = "rgb(186 244 255)",
//         heading.innerHTML = "Some Time",
//         1000);
// } )
// .then( () => {
//     return change(
...
//         heading.style.color = "rgb(158 146 242 / 97%)",
//         heading.style.textShadow = "rgb(255 237 186)",
//         1000);
// } )
// .then( () => {
//     return change(
//         heading.innerHTML = "And",
//         1000);
// } )
// .then( () => {
//     return change(
//         heading.style.transform = "translateY(0px)",
//         heading.style.transform = "rotate(350deg)",
//         1000);
// })
// .then( () => {
//     return change(
//         heading.innerHTML = "Make",
//         1000);
// } )

// // .then( () => {
// //     return change( heading.innerHTML = "Make", 1000 )
// // } )
// // .then( () => {
// //     return change( heading.style.transform = "rotate(0deg)", 1000 )
// // } )
// // .then( () => {
// //     return change( heading.innerHTML = "your", 1000)
// // } )
// // .then( () => {
// //     return change( heading.style.transform = "skew(10deg, 10deg)", 1000 )
// // } )
// // .then( () => {
// //     return change( heading.innerHTML = "mind", 1000)
// // } )
// // .then( () => {
// //     return change( heading.style.transform = "skew(0deg, 0deg)", 1000 )
// // } )
// // .then( () => {
// //     return change( heading.style.transform = "translateX(-100px)", 1000 )
// // } )
// // .then( () => {
// //     return change( heading.innerHTML = "fresh", 1000)
// // } )
// // .then( () => {
// //     return change( heading.style.transform = "translateX(100px)", 1000 )
// // } )
// // .then( () => {
// //     return change( heading.style.transform = "translateX(0px)", 1000 )
// // } )
// **************************
